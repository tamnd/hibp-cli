...
Most of these come down to network reality or how hibp serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hibp rate-limits like any public site. hibp already paces
...
Where a surface is gated, hibp reads a cookie or token you supply
...
`hibp`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hibp actually did
